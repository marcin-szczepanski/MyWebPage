...
Then run `bundle exec jekyll serve` to start the Jekyll server. Using your web browser, access the address `http://szczepanskimarcin.pl`.
...
Then, create a file named `about.md` under `_i18n/en` with the English content. Repeat this for the other languages (_i18n/es/about.md ...). When running the website, visit the address `http://szczepanskimarcin.pl/about` to see the English version, `http://szczepanskimarcin.pl/es/about` for the Spanish one, etc.
